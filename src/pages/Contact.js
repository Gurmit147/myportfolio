...
function Contact() {
    ...
    const github = ()=>{
        window.location.href = 'https://github.com/Gurmit147';
      }
  
      const twitter = ()=>{
       window.location.href = 'https://x.com/poli_psp';
      }
  
      const instagram = ()=>{
        window.location.href = 'https://www.instagram.com/politeknikseberangperai/?hl=en';
      }
    ...
    return (
        <div>
            <Sidebar />
            <div className="intro-content flex flex-col md:flex-row  min-h-screen w-full p-4 md:p-8 ml-0 md:ml-32">
            <h1 className="text-4xl sm:text-5xl text-[#e0d731] md:text-6xl font-bold mb-6">
                        Contact
                    </h1>
                    <br></br>
                <div className="text-center md:text-left  w-full w3-animate-left justify-center align-middle">
                <div className="sosial-media">
                    <div className="main">
                    <div className="up">
                        <button className="card1" onClick={instagram}>
                        ...
                        <button className="card2" onClick={twitter}>
                    ...
                    <div className="down">
                        <button className="card3" onClick={github}>
